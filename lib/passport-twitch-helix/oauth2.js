...
function Strategy(options, verify) {
    options = options || {};
    options.authorizationURL = options.authorizationURL || "https://id.twitch.tv/helix/oauth2/authorize";
    options.tokenURL = options.tokenURL || "https://id.twitch.tv/helix/oauth2/token";
...
Strategy.prototype.userProfile = function(accessToken, done) {
    this._oauth2.get("https://id.twitch.tv/helix/users", accessToken, function (err, body, res) {
